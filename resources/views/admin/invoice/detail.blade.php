        ...
        <div class="col-lg-5">
            <div class="card">
                <div class="card-body p-1">
                    ...
                    @endphp
<textarea class="form-control bg-white border" style="padding:8px 10px;font-size:13px;line-height:1.45;resize:none;min-height:520px" readonly>{{ $invoice->jp->nama_jp }}{{ $kec ? ' Kec. ' . $kec : '' }}
